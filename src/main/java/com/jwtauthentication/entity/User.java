...
public class User {
    ...
    public String toString() {
        ...
        builder.append("User [id=").append(id).append(", firstName=").append(name).append(", lastName=").append(userName).append(", email=").append(email).append(", password=").append(password).append(", enabled=").append(enabled).append(", isUsing2FA=")
